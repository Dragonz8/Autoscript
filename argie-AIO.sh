...
install_dependencies () {
  ...
  {   
    ...
    apt install -y netcat httpie vnstat 
...
wget -qO /etc/banner --header="Authorization: token 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" "https://raw.githubusercontent.com/nontikweed/blaire69/master/banner" 2>/dev/null
...
cd /etc || exit
wget -q -O /usr/sbin/sshws --header="Authorization: token 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" "https://raw.githubusercontent.com/nontikweed/aio/main/socks.py" 2>/dev/null

wget -q -O /usr/sbin/openvpnws --header="Authorization: token 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" "https://raw.githubusercontent.com/nontikweed/aio/main/openvpnws" 2>/dev/null
...
wget -O /etc/openvpn/login/auth_vpn --header="Authorization: token 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" "https://raw.githubusercontent.com/nontikweed/tite/main/premium.sh" 2>/dev/null

#client-connect file
wget -O /etc/openvpn/login/connect.sh --header="Authorization: token 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" "https://raw.githubusercontent.com/nontikweed/tite/main/connect" 2>/dev/null

sed -i "s|SERVER_IP|$server_ip|g" /etc/openvpn/login/connect.sh

#TCP client-disconnect file
wget -O /etc/openvpn/login/disconnect.sh --header="Authorization: token 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" "https://raw.githubusercontent.com/nontikweed/tite/main/disconnect.sh" 2>/dev/null
...
{
        wget -N --no-check-certificate --header="Authorization: Bearer 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" -q -O ~/install_server.sh https://raw.githubusercontent.com/nontikweed/blaire69/master/install_server.sh > /dev/null 2>&1
...
{
wget -q -O /usr/bin/badvpn-udpgw --header="Authorization: token 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" "https://raw.githubusercontent.com/nontikweed/aio/main/badvpn-udpgw64"
...
install_slowdns() {
    ...
    {  
        ...
        cd /etc/slowdns
        curl -s -H "Authorization: token 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" -o dns.sh "https://raw.githubusercontent.com/nontikweed/aio/main/dragonzdns" && chmod +x dns.sh && ./dns.sh  
        echo -e "[\e[32mInfo\e[0m] Downloading SlowDNS Files."
        wget --header="Authorization: Bearer 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" https://raw.githubusercontent.com/nontikweed/aio/main/slowdns > /dev/null 2>&1
...
installing_api(){
    ...
    echo -n -e "[\e[32mInfo\e[0m]" && echo -e " Installing API." | lolcat
    {
        ...
        wget -O /etc/slowdns/api/blaire.sh --header="Authorization: token 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" "https://raw.githubusercontent.com/nontikweed/tite/main/auth" > /dev/null 2>&1
